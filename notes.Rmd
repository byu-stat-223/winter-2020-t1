...
![](hypothesis-testing.png)
  + [Brothers](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`10/l10_brothers.Rmd`)
  + [Faithful](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`10/l10_faithful.Rmd`)
  + [GPA](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`10/l10_gpa.Rmd`)
...
+ Bootstrap Continued
  + [Bootstrap coverage](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`09/l09_bs_coverage.Rmd`)
  + [Bootstrap troubles](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
...
+ [Hypothesis Testing](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"} (`05/l05_mean.Rmd`)
+ Introduction to [Bootstrap](https://en.wikipedia.org/wiki/Bootstrapping_(statistics)){target="_blank"}
  ...
  + [Bootstrap confidence interval on mean](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`08/l08_mean.Rmd`)
  + [Memory loss](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`08/l08_memory.Rmd`)
  + [Confidence interval](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`08/l08_ci.Rmd`)
...
+ [Simulation study for simple linear regression](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
...
+ [Confidence Intervals](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`04/l04_ci.Rmd`)
...
+ Announcements:
  + [Homework 2](https://rstudio.cloud/spaces/36306/project/659054){target="_blank"} is due today at 11:59pm
+ R Moment: [r2d3](https://rstudio.github.io/r2d3/){target="_blank"}
+ [Plotting Review](https://rstudio.cloud/spaces/36306/project/669103){target="_blank"}
+ [Simulation Study Outline](sim-study-outline.html)
+ [Costume Party](https://rstudio.cloud/spaces/36306/project/669100){target="_blank"}
+ [Confidence Intervals](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`04/l04_ci.Rmd`)
+ [Homework 3](https://rstudio.cloud/spaces/36306/project/664603){target="_blank"} is assigned (due 2019-11-11 at 11:59 pm)
...
+ Announcements:
  + [Homework 1](https://rstudio.cloud/spaces/36306/project/642824){target="_blank"} due today at 11:59pm
+ R Moment: [Shiny](http://shiny.rstudio.com/){target="_blank"}
+ [Homework 1](https://rstudio.cloud/spaces/36306/project/642824){target="_blank"} questions
+ [Coding Standards](coding-standards.html)
+ [Assessing uncertainty in simulation studies](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`03/l03_flipping_coins.Rmd`)
+  [The Central Limit Theorem](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`03/l03_central_limit_theorem.Rmd`)
+ [Homework 2](https://rstudio.cloud/spaces/36306/project/659054){target="_blank"} questions
...
+ Announcements
  ...
  Cloud, click
  [here](https://rstudio.cloud/spaces/36306/join?access_code=lISYIpSfHOTpZuOcCrdybKFeJwClyi%2FC%2BtYmuyGE){target="_blank"}.
...
+ Introduction to simulation studies:
  ...
  + Especially useful when theoretical derivations are unavailable, difficult, 
    or intractable.
+ [Flipping coins](https://rstudio.cloud/spaces/36306/project/642820){target="_blank"}
(`02/l02_coins.Rmd`)
+ [Homework 2](https://rstudio.cloud/spaces/36306/project/659054){target="_blank"} is assigned (due 2019-11-04 at 11:59 pm)
...
<iframe src="https://drive.google.com/file/d/1taaVT314zHfDV_7uCaOEJGN9xIYuSnhk/preview" width="640" height="480"></iframe>

+ Please read through the [Course Syllabus](syllabus.html)
+ Please setup an account and login to [RStudio Cloud](https://rstudio.cloud/spaces/36306/join?access_code=lISYIpSfHOTpZuOcCrdybKFeJwClyi%2FC%2BtYmuyGE){target="_blank"}. If you use this link, it will automatically add you to the workspace for our class.
+ Take a look at and get started with [Homework 1](https://rstudio.cloud/spaces/36306/project/642824){target="_blank"}
