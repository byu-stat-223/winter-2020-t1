...
<iframe src="https://drive.google.com/file/d/1skjOSrn2xTRha_xDiGb9Cdm-xGV5sILf/preview" width="640" height="480"></iframe>

#### 2020-02-18

<iframe src="https://drive.google.com/file/d/1Z2cQInRqGnUXsgygJDwmySOjnU3MlTG0/preview" width="640" height="480"></iframe>
...
+ Announcements
  + [Domo Hackathon](domo-hackathon.png)
  + Lecture videos for next week will be posted on the course website
  + Optional TA labs next Tuesday and Wednesday, 3:00-4:30pm in 2104 JKB
  + Final exam
    + Exam administered and submitted through RStudio Cloud
    + Open notes, open internet - **not open neighbor**
    + Plan on ~2-3 hours
    + Review in class Monday, February 24
    + Exam opens ~6:30pm on February 24
    + Exam due 11:59pm on Wednesday (2020-02-26) (No late submissions accepted)
    + No class Wendesday (2020-02-26)
...
+ [Homework 5](https://rstudio.cloud/spaces/44710/project/816502){target="_blank"} Questions
+ Midterm Grades  
![](exam-1-grade-distribution.png)
+ [Enter the Tidyverse](https://www.tidyverse.org/){target="_blank"}  
![](data-science-workflow.png)
...
*Our present and our future will be happier if we are all always conscious of
the future. As we make current decisions we should always be asking "where will
this lead?"*

\- Dallin H. Oaks ([GC April
2019](https://www.lds.org/general-conference/2019/04/media/session_3_talk_8/6023569787001?lang=eng){target="_blank"})

+ Announcements:
  + Upcoming schedule
  + [Homework 4](https://rstudio.cloud/spaces/44710/project/816501){target="_blank"} due tonight at 11:59pm
+ R Moment: [Plumber](https://www.rplumber.io/){target="_blank"}
...
+ [There is only one test](http://allendowney.blogspot.com/2016/06/there-is-still-only-one-test.html){target="_blank"}
  + Brothers | [`10/l10_brothers.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
  + Faithful | [`10/l10_faithful.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
  + GPA | [`10/l10_gpa.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
+ [Homework 5](https://rstudio.cloud/spaces/44710/project/816502){target="_blank"} Assigned (Due 2020-12-19 at 11:59pm)
...
+ [Homework 4](https://rstudio.cloud/spaces/44710/project/816501){target="_blank"} Questions
+ Bootstrap Continued
  + Bootstrap coverage | [`09/l09_bs_coverage.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
  + Bootstrap troubles | [`09/l09_bs_troubles.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
...
\- Reyna I. Aburto (GC October 2019)

+ Announcements
  + Exam 1 opens today at approximately 6:30pm
  + Exam administered and submitted through RStudio Cloud
  + Open notes, open internet - **not open neighbor**
  + Due 11:59pm on Wednesday (2019-11-20) (No late submissions accepted)
  + Plan on ~2-3 hours
  + No class Wednesday (2019-11-20)
+ R Moment: [reticulate](https://rstudio.github.io/reticulate/){target="_blank"}
+ [Homework 4](https://rstudio.cloud/spaces/36306/project/664614){target="_blank"} Questions
+ [Exam Review](https://rstudio.cloud/spaces/36306/project/664663){target="_blank"}
  + Exam 3: Late
  + Exam 5: E-commerce
  + Exam 4: Mike Trout
...
+ Announcements:
  + Exam 1 opens a on Monday (2019-11-18)
    + In class review on Monday (2019-11-18)
    + Exam administered and submitted through RStudio Cloud
    + Open notes, open internet - **not open neighbor**
    + Due 11:59pm on Wednesday (2019-11-20) (No late submissions accepted)
    + Plan on ~2-3 hours
...
+ [Hypothesis Testing](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"} (`05/l05_mean.Rmd`)
+ Introduction to [Bootstrap](https://en.wikipedia.org/wiki/Bootstrapping_(statistics)){target="_blank"}
  ...
  + [Bootstrap confidence interval on mean](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
(`08/l08_mean.Rmd`)
  + [Memory loss](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
(`08/l08_memory.Rmd`)
  + [Confidence interval](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
(`08/l08_ci.Rmd`)
+ [Homework 4](https://rstudio.cloud/spaces/36306/project/664614){target="_blank"} is assigned (due 2019-11-25 at 11:59pm)
-->
...
<iframe src="https://drive.google.com/file/d/1qiNxEq4D4gzR_lzc4EYuaZ8zfrdipXZh/preview" width="640" height="480"></iframe>
...
+ Bootstrap confidence interval on mean | [`08/l08_mean.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
+ Memory loss | [`08/l08_memory.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
+ Confidence interval | [`08/l08_ci.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
+ [Homework 4](https://rstudio.cloud/spaces/44710/project/816501){target="_blank"} is assigned (Due 2020-02-10 at 11:59pm)

#### 2020-01-27

+ Announcements:
  + Midterm opens Today at ~6:30
    + Exam administered and submitted through RStudio Cloud
    + Open notes, open internet - **not open neighbor**
    + Due 11:59pm on Wednesday (2020-01-29) (No late submissions accepted)
    + Plan on ~2-3 hours
    + No class Wednesday (2020-01-29)
  + Homework 3 due tonight at 11:59pm
    
+ [Midterm Review](https://rstudio.cloud/spaces/44710/project/816503){target="_blank"}
  + Note: If you don't see the most recent exam (exam 6), click on the **Git** pane in the top right-hand corner and then click **Pull**
...
+ Announcemnts:
  + RStudio Cloud issues
  + I'm out of town Monday. A TA will conduct an in-class review for the midterm
  + Midterm opens Monday at 6:30
    + Exam administered and submitted through RStudio Cloud
    + Open notes, open internet - **not open neighbor**
    + Due 11:59pm on Wednesday (2020-01-29) (No late submissions accepted)
    + Plan on ~2-3 hours
    + No class Wednesday (2020-01-29)
+ Confidence Intervals | [`04/l04_ci.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
+ Simulation study for simple linear regression | [`06/l06_regression.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
+ [Homework 3](https://rstudio.cloud/spaces/44710/project/816500){target="_blank"} is assigned (Due 2020-01-27 at 6:30pm)
...
+ Announcements:
  + [Assignment Checklist](assignments.html) has been updated
+ R Moment: [r2d3](https://rstudio.github.io/r2d3/){target="_blank"}
+ [Simulation Study Outline](sim-study-outline.html)
+ [Plotting Review](https://rstudio.cloud/spaces/44710/project/816508){target="_blank"}
+ [Costume Party](https://rstudio.cloud/spaces/44710/project/816507){target="_blank"}
+ Confidence Intervals | [`04/l04_ci.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
...
+ Announcements:
  + [Homework 1](https://rstudio.cloud/spaces/44710/project/816498){target="_blank"} due today at 11:59pm
  + CFP National Championship Tonight - root for, LSU?, I guess?
...
+ Assessing uncertainty in simulation studies | [`03/l03_flipping_coins.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
+ The Central Limit Theorem | [`03/l03_central_limit_theorem.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
+ [Plotting Review](https://rstudio.cloud/spaces/44710/project/816508){target="_blank"}
+ [Homework 2](https://rstudio.cloud/spaces/44710/project/816499){target="_blank"} is assigned (Due 2020-01-21 at 11:59pm)
...
+ Announcements
  ...
  Cloud, click
  [here](https://rstudio.cloud/spaces/44710/join?access_code=MQkE91b62JJFRv5wQGBBhDWkN9w9904eywo5uDhZ){target="_blank"}.
...
+ [Homework 1](https://rstudio.cloud/spaces/44710/project/816498){target="_blank"} Questions
+ [Stat 223 Style Guide](coding-standards.html)
+ Introduction to simulation studies:
  ...
  + Especially useful when theoretical derivations are unavailable, difficult, 
    or intractable.
+ Flipping coins | [`02/l02_coins.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
...
+ Introduction to [RStudio Cloud](https://rstudio.cloud){target="_blank"}
  ...
  + Access the [course workspace](https://rstudio.cloud/spaces/44710/join?access_code=MQkE91b62JJFRv5wQGBBhDWkN9w9904eywo5uDhZ){target="_blank"}
  + All assignments **must** remain in the course workspace in order to be graded
+ Why R is awesome (Stat 123 Review) | [`01/l01_review.Rmd`](https://rstudio.cloud/spaces/44710/project/816497){target="_blank"}
+ [Homework 1](https://rstudio.cloud/spaces/44710/project/816498){target="_blank"} is assigned (Due 2020-01-13 at 11:59 pm)
